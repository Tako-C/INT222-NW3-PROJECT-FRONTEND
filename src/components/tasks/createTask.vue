    ...
    >
      ...
      <div class="itbkk-modal-task mt-3 mb-20 ml-7">
        ...
        <input
          ...
          maxlength="100"
        />
        <p class=" flex justify-end pr-28 text-[10px]">{{ taskData.title === null ? "0" : taskData.title.length}}/100</p>
        ...
        ></textarea>
        <p class=" flex justify-end pr-28 text-[10px]">{{ taskData.description === null ? "0" : taskData.description.length}}/500</p>
        ...
        ></textarea>
        <p class=" flex justify-end pr-28 text-[10px]">{{ taskData.description === null ? "0" : taskData.assignees.length}}/30</p>
