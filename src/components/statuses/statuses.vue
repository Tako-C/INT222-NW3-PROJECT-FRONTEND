...
const isStatusPage = computed(() => route.path.endsWith(`/board/${boardId.value}/status`));
    ...
    <!-- Board Section -->
        ...
        <div v-show="isStatusDropdownOpen" class="w-60 mt-2 pl-4 border border-gray-300 bg-white rounded-md shadow-lg max-h-20 overflow-y-auto">
            ...
            >
                ...
                <p @click="openCreateStatus" class="pl-2 cursor-pointer">Create Status</p>
            </div>
        ...
        <tbody v-show="Store.statuses.length === 0" class="w-full flex justify-center mt-16">
          <tr>
