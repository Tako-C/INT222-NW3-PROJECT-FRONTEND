...
async function removeTask() {
    ...
    case 400:
      ...
      break
    case 404:
      Store.errortext404 = "The Task does not exist"
      Store.errorPage404 = true
      errorPermission()
      break;
    case 403:
...
<template>
    <div class="w-screen bg-white h-screen flex">
        ...
        <modalconfirmed
            ...
            :taskTitle="taskTitle"
            @closemodal="closeNotificationModal()"
            @confirmed="checkrequestNewToken(router),removeTask()"
            class="z-40"
        />
        <sidebarV2
        ...
        <main class="h-full w-full overflow-y-scroll">
            ...
            >
                ...
                >
                    <h1>
                        {{ checkAuthToken() ? `${username}` : "Public Board" }}
                    </h1>
                ...
                <button
                    ...
                    @click="
                        checkOwner() || boardIsmycollab ? openCreateTask() : ''
                    "
                    :data-tip="
            ...
            <div class="flex flex-col items-center sm:flex-col lg:flex-row">
                ...
                <div class="flex items-center w-[60%]">
                    ...
                    <p class="p-4 mt-5 text-sm lg:text-lg">
                        Filter Status By :
                    </p>
                    <div
            ...
            <div class="flex flex-col mt-5 ml-2 lg:ml-16 w-full lg:w-4/5">
                ...
                <div class="bg-gray-100 p-4 rounded-t-lg shadow-md">
                    <!-- respon -->
                    <div
                        class="grid grid-cols-4 gap-4 text-xs md:text-sm lg:text-xl"
                    >
